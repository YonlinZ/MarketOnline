            ...
            else
            {
                Task.Run(async () =>
                {
                    ...
                    else
                    {
                        ...
                        UpdateStatus($"{stockModel.Name} {stockModel.CurrentPrice.ToString("F2")}/{stockModel.PricePercent}{(stockModel.IsUp ? "↑" : "↓")}", stockModel.IsUp ? StockColor.Red : StockColor.Green);
                    }
                });
            }
        }
